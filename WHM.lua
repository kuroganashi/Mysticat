...
function init_gear_sets()
    ...
    sets.precast.FC = {ammo="Impatiens",
		head="Nahtirah Hat",neck="Orison Locket",ear1="Mendi. Earring",ear2="Loquacious Earring",
		body="Ebers Briault",hands="Gende. Gages +1",ring1="Weatherspoon Ring",ring2="Prolix Ring",
		back="Swith Cape",waist="Witful Belt",legs="Lengo Pants",feet="Regal Pumps"} --Nahtirah Hat
    ...
    sets.precast.FC.Cure = set_combine(sets.precast.FC['Healing Magic'], {main="Rubicundity",sub="Sors Shield",ammo="Impatiens",hands="Bokwus Gloves",
	body="Nefer Kalasiris",ear2="Nourishing Earring +1",ear1="Mendi. Earring",back="Pahtli Cape",neck="Aceso's Choker +1"}) --body="Heka's Kalasris",ear2="Glorious Earring"
    ...
    sets.precast.Waltz = {
		...
		body="Ebers Briault",hands="Loagaeth Cuffs",ring1="Titan Ring",ring2="Titan Ring",
    ...
    sets.precast.WS = {
		...
		body="Ebers Briault",hands="Loagaeth Cuffs",ring1="Rajas Ring",ring2="Rufescent Ring",
    ...
    sets.precast.WS['Flash Nova'] = {ammo="Dosis Tathlum",
		...
		body="Ebers Briault",hands="Loagaeth Cuffs",ring1="Fenrir Ring",ring2="Sangoma Ring",
		back="Toro Cape",waist="Refoccilation Stone",legs="Lengo Pants",feet="Medium's Sabots"}--Fanatic Gloves
		
	sets.precast.WS['Realmrazer'] = {
		head="Ebers Cap",neck="Fotia Gorget",ear1="Brutal Earring",ear2="Moonshade Earring",
		body="Ebers Briault",hands="Loagaeth Cuffs",ring1="Levia. Ring",ring2="Rufescent Ring",
		back="Searing Cape",waist="Fotia Belt",legs="Lengo Pants",feet="Medium's Sabots"}--Fanatic Gloves
    ...
    sets.midcast.FastRecast = {ammo="Impatiens",
		head="Nahtirah Hat",ear1="Mendi. Earring",ear2="Loquacious Earring",neck="Orison Locket",
		body="Ebers Briault",hands="Gende. Gages +1",ring1="Weatherspoon Ring",ring2="Prolix Ring",
    ...
    sets.midcast.CureSolace = {main="Tamaxchi",ammo="Impatiens",
		head="Ebers Cap",neck="Aceso's Choker +1",ear2="Nourishing Earring +1",ear1="Mendi. Earring",
		body="Nefer Kalasiris",hands="Bokwus Gloves",ring1="Weatherspoon Ring",ring2="Prolix Ring",
		back="Pahtli Cape",waist="Witful Belt",legs="Ebers Pantaloons",feet="Regal Pumps"} --body="Heka's Kalasris"/Glorious Earring

    sets.midcast.Cure = {main="Tamaxchi",ammo="Impatiens",
		head="Ebers Cap",neck="Aceso's Choker +1",ear2="Nourishing Earring +1",ear1="Mendi. Earring",
		body="Nefer Kalasiris",hands="Bokwus Gloves",ring1="Weatherspoon Ring",ring2="Prolix Ring",
		back="Pahtli Cape",waist="Witful Belt",legs="Ebers Pantaloons",feet="Regal Pumps"}
    ...
    sets.midcast.Cursna = {main="Beneficus",ammo="Impatiens",
		...
		body="Ebers Briault",hands="Fanatic Gloves",ring1="Ephedra Ring",ring2="Prolix Ring",
		back="Mending Cape",waist="Witful Belt",legs="Theophany Pantaloons",feet="Gendewitha Galoshes"}

    sets.midcast.StatusRemoval = {ammo="Impatiens",back="Mending Cape",neck="Orison Locket",hands="Gende. Gages +1",
    ...
    sets.midcast['Enhancing Magic'] = {main="Beneficus",ammo="Impatiens",
		...
		back="Swith Cape",waist="Siegel Sash",legs="Piety Pantaloons",feet="Ebers Duckbills"}

    sets.midcast.Stoneskin = {ammo="Impatiens",
		head="Umuthi Hat",neck="Orison Locket",ear2="Loquacious Earring",ear1="Earthcry Earring",
		body="Ebers Briault",hands="Gende. Gages +1",ring2="Prolix Ring",
		back="Swith Cape",waist="Siegel Sash",legs="Haven Hose",feet="Regal Pumps"}
    ...
    sets.midcast.BarElement = {main="Beneficus",ammo="Impatiens",
		...
		body="Ebers Briault",hands="Ebers Mitts",ring1="Weatherspoon Ring",ring2="Prolix Ring",
		back="Swith Cape",waist="Siegel Sash",legs="Ebers Pantaloons",feet="Ebers Duckbills"}

    sets.midcast.Regen = {main="Bolelabunga",ammo="Impatiens",
		body="Piety Briault",hands="Ebers Mitts",ear1="Mendi. Earring",ear2="Loquacious Earring",ring1="Weatherspoon Ring",ring2="Prolix Ring",head="Umuthi Hat",
    ...
    sets.midcast['Divine Magic'] = {main="Rubicundity",ammo="Kalboron Stone",
		...
		body="Ebers Briault",hands="Fanatic Gloves",ring1="Weatherspoon Ring",ring2="Sangoma Ring",
    ...
    sets.midcast['Dark Magic'] = {main="Rubicundity",ammo="Kalboron Stone",
		head="Nahtirah Hat",neck="Eddy Necklace",ear1="Lifestorm Earring",ear2="Psystorm Earring",
		body="Ebers Briault",hands="Bokwus Gloves",ring1="Weatherspoon Ring",ring2="Sangoma Ring",
    ...
    sets.resting = {ammo="Homiliary",
		head="Ebers Cap",neck="Twilight Torque",body="Ebers Briault",hands="Serpentes Cuffs",ring1="Matrimony Band",ring2="Paguroidea Ring",
		waist="Fucho-No-Obi",legs="Nares Trews",feet="Serpentes Sabots"}
    

    -- Idle sets (default idle set not needed since the other three are defined, but leaving for testing purposes)
    sets.idle = {main="Bolelabunga",ammo="Homiliary",
		head="Ebers Cap",neck="Lissome Necklace",ear1="Mendi. Earring",ear2="Nourishing Earring +1",
		body="Ebers Briault",hands="Serpentes Cuffs",ring1="Matrimony Band",ring2="Paguroidea Ring",
    ...
    sets.idle.PDT = {main="Rubicundity",ammo="Homiliary",
		head="Wivre Hairpin",neck="Twilight Torque",ear1="Mendi. Earring",ear2="Nourishing Earring +1",
		body="Ebers Briault",hands="Serpentes Cuffs",ring1="Matrimony Band",ring2="Defending Ring",
    ...
    sets.idle.Weak = {main="Bolelabunga",ammo="Homiliary",
		head="Wivre Hairpin",neck="Lissome Necklace",ear1="Mendi. Earring",ear2="Nourishing Earring +1",
		body="Ebers Briault",hands="Serpentes Cuffs",ring1="Matrimony Band",ring2="Paguroidea Ring",
		back="Umbra Cape",waist="Fucho-No-Obi",legs="Assiduity Pants +1",feet="Herald's Gaiters"}
    ...
    sets.defense.PDT = {
		...
		body="Ebers Briault",hands="Gende. Gages +1",ring1="Dark Ring",ring2="Defending Ring",
    ...
    sets.engaged = {main="Rubicundity",ammo="Impatiens",
		...
		body="Ebers Briault",hands="Gende. Gages +1",ring1="Rajas Ring",ring2="K'ayres Ring",
	...
	sets.engaged.Acc = {main="Rubicundity",ammo="Impatiens",
		...
		body="Ebers Briault",hands="Gende. Gages +1",ring1="Rajas Ring",ring2="Mars's Ring",
