...
function init_gear_sets()
   ...
   sets.precast.Step = {
	...
	sets.precast.Flourish1['Violent Flourish'] =  set_combine(sets.precast.Flourish1,   {
	...
	sets.precast.Flourish1['Desperate Flourish'] =  set_combine(sets.precast.Flourish1,  {
		ammo="Yamarang",
		head="Meghanada Visor +2",
		body="Samnuha Coat",
		hands="Malignance Gloves",
   ...
   sets.midcast.FastRecast = {
	...
	sets.buff['Fan Dance'] = {
		...
		legs="Maculele Tights",
	}
	sets.buff['Climactic Flourish'] = {
		head="Maculele Tiara",
	}
	sets.buff['Wild Flourish'] = {
		hands="Maculele Bangles",
		legs="Maxixi Tights +1",
		back="Senuna's Mantle",
	}
