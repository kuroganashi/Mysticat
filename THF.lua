...
organizer_items = {
	...
	tools3="Thief Tools",
	stunbody="Onca Suit",
 	--dualwield1="Aizushintogo",
	--ambuscadedagger1="Tauret",
	--orb="Macrocosmic Orb",
}
...
function init_gear_sets()
    ...
    sets.TreasureHunter = {ammo="Per. Lucky Egg",hands="Plun. Armlets +1",feet="Skulk. Poulaines +1",waist="Chaac Belt"}
    ...
    sets.buff['Sneak Attack'] = {ammo="Per. Lucky Egg",
    ...
    sets.buff['Trick Attack'] = {ammo="Per. Lucky Egg",
		head="Meghanada Visor +2",neck="Erudit. Necklace",ear1="Sherida Earring",ear2="Cessance Earring",
    ...
    sets.precast.Waltz = {ammo="Yamarang",
		head="Mummu Bonnet +1",neck="Unmoving Collar +1",ear1="Odnowa Earring +1",ear2="Odnowa Earring",
		body={ name="Rawhide Vest", augments={'DEX+10','STR+7','INT+7',}},hands="Slither Gloves +1",ring1="Titan Ring +1",ring2="Titan Ring",
	...
	head={ name="Herculean Helm", augments={'Accuracy+9 Attack+9','"Triple Atk."+4','STR+4','Attack+6',}},neck="Voltsurge Torque",ear1="Mendi. Earring",ear2="Loquacious Earring",hands="Leyline Gloves",ring1="Weatherspoon Ring +1",ring2="Prolix Ring",
	...
	sets.precast.RangedAttack = {head="Meghanada Visor +2",ear1="Clearview Earring",ear2="Telos Earring",neck="Erudit. Necklace",back="Libeccio Mantle",body="Meg. Cuirie +2",hands="Malignance Gloves",ring1="Hajduk Ring",ring2="Hajduk Ring",legs="Meg. Chausses +2",feet="Meg. Jam. +1"}--Dampening Tam
    ...
    sets.midcast.FastRecast = {ammo="Impatiens",
		...
		body="Dread Jupon",hands="Leyline Gloves",ring1="Weatherspoon Ring +1",ring2="Prolix Ring",
	...
	sets.midcast.RangedAttack = {
		head="Meghanada Visor +2",neck="Erudit. Necklace",ear1="Clearview Earring",ear2="Telos Earring",
		body="Meg. Cuirie +2",hands="Malignance Gloves",ring1="Hajduk Ring",ring2="Hajduk Ring",
	...
	sets.midcast.RangedAttack.Acc = {
		head="Meghanada Visor +2",neck="Erudit. Necklace",ear1="Clearview Earring",ear2="Volley Earring",
		body="Meg. Cuirie +2",hands="Malignance Gloves",ring1="Hajduk Ring",ring2="Hajduk Ring",
		back="Libeccio Mantle",waist="Aquiline Belt",legs="Malignance Tights",feet="Meg. Jam. +1"}
 ...
 --Legs{ name="Taeon Tights", augments={'Accuracy+11','"Triple Atk."+2','Weapon skill damage +3%',}}
	...
	sets.defense.Evasion = {ammo="Amar Cluster",
		...
		back="Canny Cape",waist="Nusku's Sash",legs={ name="Herculean Trousers", augments={'Accuracy+17','"Triple Atk."+3','STR+5',}},feet="Volte Spats",
	}--Meghanada Visor +1

	sets.defense.PDT = {ammo="Staunch Tathlum",
		head={ name="Herculean Helm", augments={'Accuracy+9 Attack+9','"Triple Atk."+4','STR+4','Attack+6',}},neck="Loricate Torque +1",
		...
		back="Solemnity Cape",waist="Flume Belt",legs="Malignance Tights",feet={ name="Herculean Boots", augments={'"Triple Atk."+4','STR+6',}}}

	sets.defense.MDT = {ammo="Staunch Tathlum",
		head="Dampening Tam",neck="Loricate Torque +1",ear1="Odnowa Earring +1",ear2="Odnowa Earring",
		body={ name="Rawhide Vest", augments={'DEX+10','STR+7','INT+7',}},hands="Malignance Gloves",ring1="Dark Ring",ring2="Defending Ring",
		back="Solemnity Cape",waist="Flume Belt",legs="Malignance Tights",feet="Volte Spats",
	}

	sets.defense.TH = {ammo="Per. Lucky Egg",
	...
	sets.Kiting = {feet="Jute Boots +1"}
	sets.Adoulin = {feet="Jute Boots +1"}
    ...
    sets.engaged.Acc = {ammo="Amar Cluster",
		head="Meghanada Visor +2",neck="Subtlety Spec.",ear1="Digni. Earring",ear2="Telos Earring",
		body="Meg. Cuirie +2",hands="Malignance Gloves",ring1="Cacoethic Ring +1",ring2="Chirich Ring",
		back="Canny Cape",waist="Hurch'lan Sash",legs="Malignance Tights",feet="Meg. Jam. +1"}
    ...
    sets.engaged.Mod2 = {ammo="Amar Cluster",
		head="Dampening Tam",neck="Asperity Necklace",ear1="Sherida Earring",ear2="Cessance Earring",
    ...
    sets.engaged.Evasion = {ammo="Amar Cluster",
		head="Dampening Tam",neck="Erudit. Necklace",ear1="Dudgeon Earring",ear2="Telos Earring",
		body="Emet Harness +1",hands="Malignance Gloves",ring1="Petrov Ring",ring2="Epona's Ring",
    ...
    sets.engaged.Acc.Evasion = {ammo="Amar Cluster",
		head="Meghanada Visor +2",neck="Erudit. Necklace",ear1="Digni. Earring",ear2="Telos Earring",
		body="Emet Harness +1",hands="Malignance Gloves",ring1="Cacoethic Ring +1",ring2="Chirich Ring",
