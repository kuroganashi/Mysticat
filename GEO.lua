...
function init_gear_sets()
	...
	sets.precast.Waltz = {head="Geo. Galero +1",body="Bagua Tunic +1",hands="Geo. Mitaines +3",legs="Bagua Pants +1",feet="Geo. Sandals +2",neck="Unmoving Collar +1",ring1="Titan Ring",ring2="Titan Ring",
	ear1="Soil Pearl",ear2="Soil Pearl",back="Iximulew Cape"}
	
    sets.precast.FC = {main="Solstice",sub="Ammurapi Shield",
		head="Nahtirah Hat",neck="Voltsurge Torque",ear1="Mendi. Earring",ear2="Loquacious Earring",hands={ name="Telchine Gloves", augments={'"Fast Cast"+5','Enh. Mag. eff. dur. +10',}},
		body="Eirene's Manteel",ring1="Weatherspoon Ring",ring2="Kishar Ring",
		back="Ogapepo Cape",waist="Witful Belt",legs="Geo. Pants +3",feet="Regal Pumps +1"}
	...
	sets.precast.FC.Cure = {main="Tamaxchi",sub="Sors Shield",
		...
		body="Heka's Kalasiris",hands={ name="Telchine Gloves", augments={'"Fast Cast"+5','Enh. Mag. eff. dur. +10',}},ring1="Weatherspoon Ring",ring2="Kishar Ring",
		back="Pahtli Cape",waist="Witful Belt",legs="Doyen Pants",feet="Regal Pumps +1"}--Geo. Pants +1

    sets.precast.FC['Elemental Magic'] = set_combine(sets.precast.FC, {neck="Stoicheion Medal",body="Vedic Coat"})
    
	sets.precast.FC['Enhancing Magic'] = set_combine(sets.precast.FC, {waist="Siegel Sash",feet="Regal Pumps +1",sub="Ammurapi Shield"})

	----------------------------------------------------------------
	----------------------------------------------------------------
	sets.precast.FC.Stoneskin = set_combine(sets.precast.FC, {neck="Nodens Gorget",feet="Regal Pumps +1",legs="Doyen Pants",sub="Ammurapi Shield"})
	...
	sets.precast.WS = {head="Jhakri Coronal +1",neck="Fotia Gorget",ear1="Brutal Earring",
		...
		body="Jhakri Robe +2",hands="Jhakri Cuffs +1",ring1="Shukuyu Ring",ring2="Rufescent Ring",
	...
	sets.precast.WS['Flash Nova'] = {
		head="Merlinic Hood",neck="Sanctity Necklace",ear2="Regal Earring",ear1="Barkarole Earring",
		body="Jhakri Robe +2",hands="Ea Cuffs",ring1="Fenrir Ring",ring2="Acumen Ring",
		back="Nantosuelta's Cape",waist="Fotia Belt",legs="Merlinic Shalwar",feet="Merlinic Crackows"}--"Witching Robe"
    
	sets.precast.WS['Starlight'] = {ear2="Moonshade Earring"}

    sets.precast.WS['Moonlight'] = {ear2="Moonshade Earring"}

	sets.precast.WS['Exudation'] = {head="Buremte Hat",neck="Fotia Gorget",ear1="Ishvara Earring",ear2="Regal Earring",
		body="Geomancy Tunic +3",hands="Geo. Mitaines +3",ring1="Levia. Ring",ring2="Rufescent Ring",
		back="Nantosuelta's Cape",waist="Fotia Belt",legs="Geo. Pants +3",feet="Geo. Sandals +2"}--Bagua Pants +1/Buremte Hat

	sets.precast.WS['Realmrazer'] = {head="Buremte Hat",neck="Fotia Gorget",ear1="Brutal Earring",ear2="Moonshade Earring",
		body="Jhakri Robe +2",hands="Ea Cuffs",ring1="Levia. Ring",ring2="Rufescent Ring",
		back="Nantosuelta's Cape",waist="Fotia Belt",legs="Merlinic Shalwar",feet="Merlinic Crackows"}--Bagua Pants +1/Buremte Hat 
    ...
    --------------------------------------
        ...
        sets.midcast['Life Cycle'] = {body="Geomancy Tunic +3"}
        ...
        sets.midcast['Life Cycle'].Pet = {body="Geomancy Tunic +3"}
        sets.midcast['Mending Halation'].Pet = {legs="Bagua Pants +1"}        sets.midcast.Bolster.Pet.Indi = {body="Bagua Tunic +1"}
        sets.midcast['Life Cycle'].Pet.Indi = {body="Geomancy Tunic +3"}
    ...
    sets.midcast.FastRecast = {main="Solstice",
		...
		body="Eirene's Manteel",hands={ name="Telchine Gloves", augments={'"Fast Cast"+5','Enh. Mag. eff. dur. +10',}},ring1="Weatherspoon Ring",ring2="Kishar Ring",neck="Voltsurge Torque",
		back="Lifestream Cape",waist="Witful Belt",legs="Geo. Pants +3",feet="Regal Pumps +1"}

    sets.midcast.Geomancy = {main="Idris",range="Dunna",
		head="Azimuth Hood +1",body="Bagua Tunic +1",hands="Geo. Mitaines +3",
		legs="Bagua Pants +1",feet="Medium's Sabots",
		ear1="Gifted Earring",ear2="Magnetic Earring",neck="Incanter's Torque",
		back="Lifestream Cape",waist="Kobo Obi",ring1="Stikini Ring",ring2="Stikini Ring"}--"Stikini Ring"
    ...
    sets.midcast.Cure = set_combine(sets.precast.FC, {main="Tamaxchi",sub="Sors Shield",ear1="Mendi. Earring",ear2="Loquacious Earring",neck="Nodens Gorget",head="Vanya Hood",body="Heka's Kalasiris",hands={ name="Telchine Gloves", augments={'"Fast Cast"+5','Enh. Mag. eff. dur. +10',}},ring1="Stikini Ring",ring2="Stikini ring",back="Pahtli Cape",legs="Nares Trews",feet="Medium's Sabots",waist="Luminary Sash"})
	...
	sets.midcast['Elemental Magic'] = {main="Idris",sub="Culminus",
		head="Merlinic Hood",neck="Mizukage-no-Kubikazari",ear2="Regal Earring",ear1="Barkarole Earring",
		body="Jhakri Robe +2",hands="Ea Cuffs",ring2="Locus Ring",ring1="Mujin Band",
		back="Nantosuelta's Cape",waist="Refoccilation Stone",legs="Merlinic Shalwar",feet="Merlinic Crackows"}--Buremte Hat/Azimuth Coat/Lengo Pants/Loagaeth Cuffs/Welkin Crown/Azimuth Coat/Jhakri Robe +1/Witching Robe/Wretched Coat/Count's Garb
	
	sets.midcast['Elemental Magic'].Crits = {main="Idris",sub="Culminus",
		head="Merlinic Hood",neck="Mizukage-no-Kubikazari",ear2="Regal Earring",ear1="Barkarole Earring",
		body="Count's Garb",hands="Ea Cuffs",ring2="Locus Ring",ring1="Mujin Band",
		back="Nantosuelta's Cape",waist="Refoccilation Stone",legs="Merlinic Shalwar",feet="Merlinic Crackows"}--Buremte Hat/Azimuth Coat/Lengo Pants/Loagaeth Cuffs/Welkin Crown/Azimuth Coat/Jhakri Robe +1/Witching Robe/Wretched Coat/Count's Garb
	
	sets.magic_burst = {neck="Mizukage-no-Kubikazari",ring2="Locus Ring",ring1="Mujin Band",hands="Ea Cuffs"}--Count's Garb
	
	sets.midcast['Enfeebling Magic'] = {main="Idris",sub="Culminus",
		head="Merlinic Hood",neck="Sanctity Necklace",ear1="Digni. Earring",ear2="Regal Earring",
		body="Geomancy Tunic +3",hands="Geo. Mitaines +3",ring1="Weatherspoon Ring",ring2="Stikini Ring",
		back="Nantosuelta's Cape",waist="Luminary Sash",legs="Geo. Pants +3",feet="Geo. Sandals +2"}--Nahtirah Hat/Azimuth Gloves/Ischemia Chasu.
	
	sets.midcast.Drain = {main="Rubicundity",sub="Culminus",
		head="Bagua Galero +1",neck="Sanctity Necklace",ear2="Regal Earring",ear1="Digni. Earring",
		body="Geomancy Tunic +3",hands="Geo. Mitaines +3",ring1="Stikini Ring",ring2="Stikini Ring",
		back="Nantosuelta's Cape",waist="Fucho-No-Obi",legs="Azimuth Tights",feet="Merlinic Crackows"}--Jhakri Robe +1 / Geo. Tunic +1

	sets.midcast.Aspir = sets.midcast.Drain
	
	sets.midcast.Stun = {main="Idris",sub="Culminus",
		head="Merlinic Hood",neck="Sanctity Necklace",ear1="Digni. Earring",ear2="Regal Earring",
		body="Geomancy Tunic +3",hands="Geo. Mitaines +3",ring1="Weatherspoon Ring",ring2="Stikini Ring",
		back="Nantosuelta's Cape",waist="Luminary Sash",legs="Geo. Pants +3",feet="Geo. Sandals +2"}
    ...
    -- Resting sets
    sets.resting = {main="Bolelabunga",head="Befouled Crown",neck="Sanctity Necklace",ear2="Regal Earring",ear1="Digni. Earring",
...
--Nantosuelta's Cape (DEF:15 Indicolure effect duration +20 "Life Cycle"+10)
    ...
    sets.idle = {main="Bolelabunga",sub="Culminus",range="Dunna",
		head="Befouled Crown",neck="Sanctity Necklace",ear1="Handler's Earring +1",ear2="Handler's Earring",
		body="Jhakri Robe +2",hands="Bagua Mitaines +1",ring1="Dark Ring",ring2="Defending Ring",
		back="Umbra Cape",waist="Fucho-No-Obi",legs="Assiduity Pants +1",feet="Bagua Sandals +1"}--Arciela's Grace +1,Lifestream Cape

    sets.idle.PDT = {main="Bolelabunga",sub="Culminus",range="Dunna",
		head="Befouled Crown",neck="Twilight Torque",ear1="Handler's Earring +1",ear2="Handler's Earring",
		body="Jhakri Robe +2",hands="Geo. Mitaines +3",ring1="Dark Ring",ring2="Defending Ring",
		back="Umbra Cape",waist="Refoccilation Stone",legs="Assiduity Pants +1",feet="Geo. Sandals +2"}

	sets.idle.MDT = {main="Bolelabunga",sub="Culminus",range="Dunna",
		head="Befouled Crown",neck="Twilight Torque",ear1="Handler's Earring +1",ear2="Loquacious Earring",
		body="Jhakri Robe +2",hands="Geo. Mitaines +3",ring1="Dark Ring",ring2="Defending Ring",
		back="Solemnity Cape",waist="Isa Belt",legs="Assiduity Pants +1",feet="Merlinic Crackows"}	
		
    -- .Pet sets are for when Luopan is present.
    sets.idle.Pet = {main="Idris",sub="Culminus",range="Dunna",
		head="Azimuth Hood +1",neck="Incanter's Torque",ear1="Handler's Earring +1",ear2="Handler's Earring",
		body="Jhakri Robe +2",hands="Geo. Mitaines +3",ring1="Stikini Ring",ring2="Stikini Ring",
	...
	-- Pet Regen:
    --sets.idle.PDT.Indi = set_combine(sets.idle.PDT, {main="Idris",legs="Bagua Pants +1",feet="Bagua Sandals +1",back="Nantosuelta's Cape",ring1="Stikini Ring",ring2="Stikini Ring"})
    ...
    sets.idle.Town = {main="Idris",sub="Culminus",range="Dunna",
		head="Befouled Crown",neck="Sanctity Necklace",ear1="Handler's Earring +1",ear2="Handler's Earring",
		body="Jhakri Robe +2",hands="Bagua Mitaines +1",ring1="Dark Ring",ring2="Defending Ring",
		back="Lifestream Cape",waist="Fucho-No-Obi",legs="Azimuth Tights",feet="Bagua Sandals +1"} --Bolelabunga/Paguroidea Ring

    sets.idle.Weak = {main="Bolelabunga",sub="Culminus",range="Dunna",
		head="Befouled Crown",neck="Sanctity Necklace",ear1="Handler's Earring +1",ear2="Handler's Earring",
		body="Jhakri Robe +2",hands="Bagua Mitaines +1",ring1="Dark Ring",ring2="Defending Ring",
		back="Umbra Cape",waist="Fucho-No-Obi",legs="Assiduity Pants +1",feet="Bagua Sandals +1"}
    ...
    sets.defense.PDT = {main="Idris",sub="Culminus",range="Dunna",
		...
		body="Geomancy Tunic +3",hands="Geo. Mitaines +3",ring1="Dark Ring",ring2="Defending Ring",
    ...
    sets.defense.MDT = {main="Idris",sub="Culminus",range="Dunna",
		...
		body="Geomancy Tunic +3",hands={ name="Telchine Gloves", augments={'"Fast Cast"+5','Enh. Mag. eff. dur. +10',}},ring1="Dark Ring",ring2="Defending Ring",
		back="Solemnity Cape",waist="Isa Belt",legs="Jhakri Slops +1",feet="Jhakri Pigaches +1"}
    ...
    sets.engaged = {main="Idris",range="Dunna",
		...
		body="Jhakri Robe +2",hands="Jhakri Cuffs +1",ring1="Petrov Ring",ring2="Hetairoi Ring",
		back="Solemnity Cape",waist="Windbuffet Belt +1",legs="Jhakri Slops +1",feet="Jhakri Pigaches +1"}--Count's Garb

	sets.engaged.Acc = {main="Idris",range="Dunna",
		head="Alhazen Hat +1",neck="Subtley Spec.",ear1="Digni. Earring",ear2="Cessance Earring",
		body="Jhakri Robe +2",hands="Jhakri Cuffs +1",ring1="Cacoethic Ring +1",ring2="Cacoethic Ring",
		back="Solemnity Cape",waist="Witful Belt",legs="Jhakri Slops +1",feet="Jhakri Pigaches +1"}
