...
function init_gear_sets()
	...
	sets.precast.JA['Chi Blast'] = {
		...
		body="Reiki Osode",hands="Hes. Gloves +1",ring1="Levia. Ring",ring2="Rufescent Ring",
 ...
 sets.precast.Waltz = {ammo="Sonia's Plectrum",
	...
	hands="Hizamaru Kote +1",legs="Hiza. Hizayoroi +1",feet="Hiza. Sune-Ate +1",body="Reiki Osode",neck="Subtlety Spectacles",ear1="Digni. Earring"}
    ...
    sets.precast.FC = {ammo="Impatiens",head={ name="Herculean Helm", augments={'Accuracy+9 Attack+9','"Triple Atk."+4','STR+4','Attack+6',}},neck="Voltsurge Torque",body="Dread Jupon",ear1="Mendi. Earring",ear2="Loquacious Earring",ring1="Weatherspoon Ring",ring2="Prolix Ring",legs="Rawhide Trousers",
    ...
    sets.precast.WS = {ammo="Knobkierrie",
		...
		body="Hiza. Haramaki +1",hands="Hizamaru Kote +1",ring1="Niqmaddu Ring",ring2="Epona's Ring",
    ...
    sets.midcast.FastRecast = {ammo="Impatiens",
		...
		body="Dread Jupon",hands="Leyline Gloves",ring1="Weatherspoon Ring",ring2="Prolix Ring",back="Mujin Mantle",legs="Rawhide Trousers",
    ...
    sets.midcast.Utsusemi = {ammo="Impatiens",
		...
		body="Dread Jupon",hands="Leyline Gloves",ring1="Weatherspoon Ring",ring2="Prolix Ring",back="Mujin Mantle",
    ...
    sets.defense.MDT = {ammo="Staunch Tathlum",
		...
		body="Emet Harness +1",hands={ name="Herculean Gloves", augments={'Attack+18','"Triple Atk."+3','Accuracy+11',}},ring1="Dark Ring",ring2="Defending Ring",
		back="Solemnity Cape",waist="Moonbow Belt",legs="Ta'lab Trousers",feet={ name="Herculean Boots", augments={'"Triple Atk."+4','STR+6',}}}
    ...
    sets.engaged.Acc = {ammo="Amar Cluster",
		...
		body="Reiki Osode",hands="Hizamaru Kote +1",ring1="Cacoethic Ring +1",ring2="Chirich Ring",
