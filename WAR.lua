...
function user_setup()
    ...
    state.OffenseMode:options('Normal', 'Acc', 'Test1', 'Test2', 'Store_TP', 'DA')--, 'Mid'
...
function init_gear_sets()
    ...
    --Odyssean.Feet.TP = { name="Odyssean Greaves", augments={'Accuracy+16 Attack+16','"Store TP"+4','DEX+1','Accuracy+13','Attack+15',}}
	 ...
	 sets.precast['Aggressor'] = {head="Pumm. Mask +2",body="Agoge Lorica +3"}
	...
	-- WEAPONSKILL SETS ----------------------------------------------
     ...
     sets.precast.WS.Mid = set_combine(sets.precast.WS, {neck="Fotia Gorget",waist="Fotia Belt",legs="Pumm. Cuisses +2",feet="Pumm. Calligae +2",body="Pumm. Lorica +3"})
     sets.precast.WS.Acc = set_combine(sets.precast.WS.Mid, {neck="Fotia Gorget",waist="Fotia Belt",legs="Pumm. Cuisses +2",feet="Pumm. Calligae +2",body="Pumm. Lorica +3",head="Pumm. Mask +2"})
	...
	sets.precast.WS['Full Break'] = set_combine(sets.precast.WS, {
	 ...
	 -- Steel Cyclone
	 -- 60% STR 60% VIT
	sets.precast.WS['Steel Cyclone'] = set_combine(sets.precast.WS, {neck="Fotia Gorget",waist="Fotia Belt"})
	...
	sets.precast.WS['Metatron Torment'] = set_combine(sets.precast.WS, {
	 ...
	 feet="Sulev. Leggings +2",
	 ear1="Thrud Earring",
	 neck="Fotia Gorget",waist="Fotia Belt"})--WSD+
    ...
    sets.precast.WS["Ukko's Fury"] = set_combine(sets.precast.WS, {
	 ...
	 ring1="Begrudging Ring",
	 back={ name="Cichol's Mantle", augments={'STR+20','Accuracy+20 Attack+20','"Dbl.Atk."+10',}},
	 neck="Fotia Gorget",waist="Fotia Belt"})--13,516
	 ...
	 ring1="Begrudging Ring",
	 back={ name="Cichol's Mantle", augments={'STR+20','Accuracy+20 Attack+20','"Dbl.Atk."+10',}},
	 neck="Fotia Gorget",waist="Fotia Belt"})--12,438
	 ...
	 ring1="Begrudging Ring",
	 back={ name="Cichol's Mantle", augments={'STR+20','Accuracy+20 Attack+20','"Dbl.Atk."+10',}},
	 neck="Fotia Gorget",waist="Fotia Belt"})--13,346
    ...
    sets.precast.WS['Ground Stike'].Acc = set_combine(sets.precast.WS['Ground Stike'].Mid, sets.precast.WS.Acc)
     ...
     -- TORCLEAVER 
     -- VIT 80%
     sets.precast.WS.Torcleaver = set_combine(sets.precast.WS, {hands={ name="Odyssean Gauntlets", augments={'Accuracy+21','Weapon skill damage +4%','AGI+10','Attack+10',}},ring1="Titan Ring",
	 ring2="Niqmaddu Ring",feet="Sulev. Leggings +2",head="Sulevia's Mask +1",body="Pumm. Lorica +3",ear1="Thrud Earring",
	back={ name="Cichol's Mantle", augments={'VIT+20','Accuracy+20 Attack+20','VIT+10','Weapon skill damage +10%',}},waist="Fotia Belt",neck="Fotia Gorget",legs={ name="Odyssean Cuisses", augments={'Accuracy+25 Attack+25','Weapon skill damage +2%','STR+5','Attack+14',}}})
	 ...
	 --Impulse Drive
	 --100%
	 sets.precast.WS['Impulse Drive'] = set_combine(sets.precast.WS, {ear1="Thrud Earring"})
    ...
    sets.precast.WS.Stardiver = set_combine(sets.precast.WS, {
	 ...
	 --Savage Blade
	 --50 STR 50 MND
	 sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {ear1="Thrud Earring"})
     ...
     sets.precast.WS['Sanguine Blade'] = set_combine(sets.precast.WS, {ammo="Pemphredo Tathlum",
		head="Pixie Hairpin +1",neck="Sanctity Necklace",waist="Eschan Stone",ear1="Friomisi Earring",ear2="Hecate's Earring",
		body="Sulevia's Plate. +2",hands="Sulev. Gauntlets +2",ring1="Fenrir Ring",ring2="Fenrir Ring",
		back="Toro Cape",legs="Pumm. Cuisses +2",feet="Reverence Leggings"})
     ...
     sets.precast.WS.Requiescat = set_combine(sets.precast.WS, {ring1="Levia. Ring",ring2="Rufescent Ring",back={ name="Cichol's Mantle", augments={'STR+20','Accuracy+20 Attack+20','"Dbl.Atk."+10',}},head="Sulevia's Mask +1",body="Agoge Lorica +3",feet="Pumm. Calligae +2",legs="Sulev. Cuisses +2",hands="Sulev. Gauntlets +2"})
	 ...
	 --Starburst
	 --40 STR 40 MND
	 sets.precast.WS['Starburst'] = set_combine(sets.precast.WS, {})
	 ...
	 --Infernal Scythe
	 --STR 30 INT 70
	 sets.precast.WS['Infernal Scythe'] = set_combine(sets.precast.WS, {ear1="Thrud Earring"})
	 ...
	 --Gale Axe
	 --STR 100
	 sets.precast.WS['Gale Axe'] = set_combine(sets.precast.WS, {ear1="Thrud Earring"})
	 ...
	 --Cloudsplitter
	 --STR 40 MND 40
	 sets.precast.WS['Cloudsplitter'] = set_combine(sets.precast.WS, {ear1="Thrud Earring"})
	...
	sets.midcast.Provoke = {
     ...
     sets.resting = {ammo="Staunch Tathlum",
		head={ name="Valorous Mask", augments={'Accuracy+30','Weapon skill damage +4%','VIT+12',}},neck="Sanctity Necklace",ear1="Brutal Earring",ear2="Cessance Earring",
        body="Sulevia's Plate. +2",hands="Sulev. Gauntlets +2",ring1="Chirich Ring",ring2="Chirich Ring",
        back="Solemnity Cape",waist="Ioskeha Belt",legs="Sulev. Cuisses +2",feet="Hermes' Sandals"}
     ...
     sets.idle.Regen = set_combine(sets.idle.Field, {neck="Sanctity Necklace",ear1="Infused Earring",ring1="Chirich Ring",ring2="Chirich Ring"})
 
     sets.idle.Weak = {ammo="Staunch Tathlum",
		head={ name="Valorous Mask", augments={'Accuracy+30','Weapon skill damage +4%','VIT+12',}},neck="Sanctity Necklace",ear1="Brutal Earring",ear2="Cessance Earring",
        body="Sulevia's Plate. +2",hands="Sulev. Gauntlets +2",ring1="Dark Ring",ring2="Defending Ring",
        back="Solemnity Cape",waist="Ioskeha Belt",legs="Sulev. Cuisses +2",feet="Hermes' Sandals"}
	...
	--Dark Ring PDT-3 MDT-3
     ...
     sets.Defensive = {ammo="Staunch Tathlum",
		...
		body="Sulevia's Plate. +2",hands="Sulev. Gauntlets +2",ring1="Dark Ring",ring2="Defending Ring",
		back="Solemnity Cape",waist="Ioskeha Belt",legs="Sulev. Cuisses +2",feet="Sulev. Leggings +2"}
     sets.Defensive_Mid = {ammo="Staunch Tathlum",
		head="Sulevia's Mask +1",neck="Twilight Torque",ear1="Brutal Earring",ear2="Cessance Earring",
		body="Sulevia's Plate. +2",hands="Sulev. Gauntlets +2",ring1="Dark Ring",ring2="Defending Ring",
		back="Solemnity Cape",waist="Ioskeha Belt",legs="Sulev. Cuisses +2",feet="Sulev. Leggings +2"}
     sets.Defensive_Acc = {ammo="Amar Cluster",
		head="Sulevia's Mask +1",neck="Twilight Torque",ear1="Brutal Earring",ear2="Cessance Earring",
		body="Sulevia's Plate. +2",hands="Sulev. Gauntlets +2",ring1="Dark Ring",ring2="Defending Ring",
		back="Solemnity Cape",waist="Ioskeha Belt",legs="Pumm. Cuisses +2",feet="Sulev. Leggings +2"}
     ...
     sets.engaged = {
		...
		--Legs DA+8
		--Feet DA+6
		--Total: DA+56 (+23)=(DA+79) TA+5 QA+3%
	...
	sets.engaged.Store_TP = {
	 ...
	 sets.engaged.SW = set_combine(sets.engaged, {legs="Boii Cuisses"})
	 
	 sets.engaged.SW.DA = set_combine(sets.engaged.DA, {legs="Boii Cuisses"})--Boii Mask
	 
	 sets.engaged.SW.Mid = set_combine(sets.engaged.Mid, {legs="Boii Cuisses"})
	 
	 sets.engaged.SW.Acc = set_combine(sets.engaged.Acc, {legs="Boii Cuisses"})
	 
	 sets.engaged.SW.Store_TP = set_combine(sets.engaged.Store_TP, {legs="Boii Cuisses"})
	 
     sets.engaged.DW = set_combine(sets.engaged, {ear1="Dudgeon Earring",ear2="Heartseeker Earring"})
	 ...
	 sets.engaged.DW.Mid = set_combine(sets.engaged.Mid, {ear1="Dudgeon Earring",ear2="Heartseeker Earring"})
	 ...
	 sets.engaged.OneHand.Mid = set_combine(sets.engaged.Mid, {})
	 
	 sets.engaged.OneHand.Acc = set_combine(sets.engaged.Acc, {})
	 
	 sets.engaged.OneHand.Store_TP = set_combine(sets.engaged.Store_TP, {})
	 ...
	 sets.engaged.Reraise.Mid = set_combine(sets.engaged.Mid, {head="Twilight Helm",body="Twilight Mail"})
	 
	 sets.engaged.Reraise.Acc = set_combine(sets.engaged.Acc, {head="Twilight Helm",body="Twilight Mail"})
	 
	 sets.engaged.Reraise.Store_TP = set_combine(sets.engaged.Store_TP, {head="Twilight Helm",body="Twilight Mail"})
